...
def prepare_scenario2():
    setPlane("urn:test:Plane2", "urn:test:GateA2")
    setPlane("urn:test:Plane3", "urn:test:GateB1")

def remove_scenario2():
    removePlane("urn:test:Plane2", "urn:test:GateA2")
    removePlane("urn:test:Plane3", "urn:test:GateB1")
...
def prepare_base():
    ...
    #print(listId)
    setPlane("urn:test:Plane1", "urn:test:GateA1")
    setPlane("urn:test:Plane5", "urn:test:GateB2")
